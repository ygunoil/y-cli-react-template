...
class telBind extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div className = 'container'>
        ...
        <div className = "content">
         <div className = "telContent">
            <input type="text" autoFocus name="userID"  ref="userID" placeholder="请输入手机号码"/>
            <input type="password" name="password" ref="password" placeholder="输入手机验证码"/>
            <input type="password" name="password" ref="password" placeholder="输入验证码"/>
            <input type="button"  value="提交绑定" onClick = { this.login.bind(this) }/>
          </div>
